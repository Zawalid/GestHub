...
import { useCities, useOffers, useSectors } from '@/features/offers/useOffers';
...
export const useOffersProps = (offers, isLoading, error) => {
  ...
  return {
    ...
    filters: {
      sector: sectors?.map((s) => ({ value: s, checked: false })) || [],
      city: cities?.map((s) => ({ value: s, checked: false })) || [],
      experience: [
